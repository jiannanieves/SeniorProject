...
*
* \funcusage
*  \snippet LAT_SUT.c usage_LAT_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LAT_SUT.c usage_LAT_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LAT_SUT.c usage_LAT_Read  
*******************************************************************************/
uint8 LAT_Read(void)
{
...
* preferred LAT_Read() API because the 
* LAT_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LAT_SUT.c usage_LAT_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LAT_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LAT_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LAT_0_INTR       (First pin in the list)
    *  - LAT_1_INTR       (Second pin in the list)
    *  - ...
    *  - LAT_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LAT_SUT.c usage_LAT_SetInterruptMode
    *******************************************************************************/
    void LAT_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & LAT_0_INTR) != 0u) 
		{ 
			 LAT_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LAT_SUT.c usage_LAT_ClearInterrupt
    *******************************************************************************/
